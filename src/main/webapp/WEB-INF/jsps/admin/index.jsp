...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function initMenu(){
			...
			$.post("common/findAllFunctionList", function(rsp) {
 ...
 <body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:40px;background:#EEE;padding:10px;overflow: hidden;"  href="layout/north"></div>
	<div data-options="region:'west',split:true,title:'主要菜单'" style="width:200px;">
			<div id="menuAccordion"></div>
	</div> 
	<div data-options="region:'south',border:false" style="height:25px;background:#EEE;padding:5px;" href="layout/south"></div>
	<div data-options="region:'center',plain:true,title:'论坛后台管理'" style="overflow: hidden;"  href="layout/center"></div>
