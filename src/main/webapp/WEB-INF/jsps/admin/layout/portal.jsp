...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/jquery-easyui/extend/jquery.portal.js"></script>
  	<link rel="stylesheet" href="resources/jquery-easyui/extend/portal.css" type="text/css"></link>
	...
	$(function(){
		...
		$("#chartContainer").insertFusionCharts({
			swfUrl: "resources/jquery-easyui/js/FusionCharts/Column2D.swf",
		...
		$("#chartContainer2").insertFusionCharts({
			swfUrl: "resources/jquery-easyui/js/FusionCharts/MSColumn3D.swf",
			//dataSource: "js/FusionCharts/Data.xml",
			//dataFormat: "xmlurl",
			width: parseInt($(this).width()*0.5)-80,
			height: parseInt($(this).height()*0.4),
